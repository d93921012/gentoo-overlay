...
src_prepare() {
	default
	sed -e 's/^OPTFLAGS=.*/OPTFLAGS="$CFLAGS $CPPFLAGS -Wno-error=implicit-function-declaration -Wno-error=incompatible-pointer-types -Wno-error=int-conversion"/' \
	-i configure
